...
export default(req, res) => {
    res
        ...
        .json([{
            ...
            slug:"numbersGame",
            url: "https://amzn.to/3R6skEp",
            title:"The Numbers Game",
            author: "Chris Anderson and David Sally",
            description: "Some stats to crush old-school football myths and show you how the game is actually won. Must read.",
            cover: "https://m.media-amazon.com/images/I/71lQppvErAL._SY522_.jpg"
        }])
}
