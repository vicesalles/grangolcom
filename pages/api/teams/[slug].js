...
const teams = {
  en: [
    ...
    { slug: "olivera", name: "Olivera", mainColor: "green", secondColor: "white", description: "English description", mainPlayer: "Fàtima (8)" },
  ...
  ca: [
    ...
    { slug: "olivera", name: "Olivera", mainColor: "green", secondColor: "white", description: "Descripció en Català", mainPlayer: "Fàtima (8)" },
    { slug: "miners", name: "Club Atlètic Miner", mainColor: "yellow", secondColor: "black", description: "English description", mainPlayer: "Otger (10)"}
  ],
  es: [
    { slug: "vapor", name: "CE El Vapor", mainColor: "black", secondColor: "white", description: "Descripción en Español", mainPlayer: "Fàtima (8)" },
    { slug: "olivera", name: "Olivera", mainColor: "green", secondColor: "white", description: "Descripción en Español", mainPlayer: "Fàtima (8)" },
    { slug: "miners", name: "Club Atlètic Miner", mainColor: "yellow", secondColor: "black", description: "English description", mainPlayer: "Otger (10)"}
  ]
};
